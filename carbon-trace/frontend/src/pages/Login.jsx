    ...
    <div className="min-h-[100dvh] bg-gradient-to-b from-brand-600 via-brand-700 to-brand-900 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="mt-5 text-4xl font-bold tracking-tight text-white">碳迹</h1>
        ...
        >
          <h2 className="font-semibold text-ink-900">开启你的碳迹之旅</h2>
          ...
          >
            {loading ? '正在进入…' : ready ? '开始碳迹之旅' : '设备初始化中…'}
          </button>
